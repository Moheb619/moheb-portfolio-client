...
class ContactSide extends React.Component {
  state = {
    ...
    message: "",
    ContactItems: [
      { id: 1, title: "E-mail", body: "6moheb19@gmail.com" },
      { id: 2, title: "Address", body: "979 South Ibrahimpur , Dhaka Cantonment , Dhaka-1206" },
      { id: 3, title: "Phone", body: "01908164943" },
    ],
  };
  ...
  handleSubmit = async (event) => {
    ...
    const res = await axios.post("https://fast-sea-63045.herokuapp.com/contact", data);
      ...
      <>
        ...
        <div className="leave-Message">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <button type="submit" className="m-3 text-white o-btn text-center py-2 position-relative">
                Send Message
              </button>
            </div>
          </form>
